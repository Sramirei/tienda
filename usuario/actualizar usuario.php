...
$sql = "UPDATE usuario SET Nombre ='$Nombre', Apellido ='$Apellido', Email ='$Email', Clave ='$Clave', Telefono ='$Telefono', Direccion ='$Direccion', Ciudad ='$Ciudad', Foto ='$Foto', Roles_idroles ='$Roles_idroles' WHERE usuario_id='$usuario_id';";
